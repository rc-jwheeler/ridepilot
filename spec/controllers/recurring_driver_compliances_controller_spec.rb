...
RSpec.describe RecurringDriverCompliancesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested recurring_driver_compliance as @recurring_driver_compliance" do
      recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
      get :show, {:id => recurring_driver_compliance.to_param}
  ...
  describe "GET #edit" do
    it "assigns the requested recurring_driver_compliance as @recurring_driver_compliance" do
      recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
      get :edit, {:id => recurring_driver_compliance.to_param}
      expect(assigns(:recurring_driver_compliance)).to eq(recurring_driver_compliance)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new RecurringDriverCompliance" do
        expect {
          post :create, {:recurring_driver_compliance => valid_attributes}
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved recurring_driver_compliance as @recurring_driver_compliance" do
        post :create, {:recurring_driver_compliance => invalid_attributes}
        expect(assigns(:recurring_driver_compliance)).to be_a_new(RecurringDriverCompliance)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested recurring_driver_compliance" do
        recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
        put :update, {:id => recurring_driver_compliance.to_param, :recurring_driver_compliance => new_attributes}
      ...
      it "assigns the requested recurring_driver_compliance as @recurring_driver_compliance" do
        recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
        put :update, {:id => recurring_driver_compliance.to_param, :recurring_driver_compliance => valid_attributes}
        expect(assigns(:recurring_driver_compliance)).to eq(recurring_driver_compliance)
      end
    ...
    context "with invalid params" do
      it "assigns the recurring_driver_compliance as @recurring_driver_compliance" do
        recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
        put :update, {:id => recurring_driver_compliance.to_param, :recurring_driver_compliance => invalid_attributes}
        expect(assigns(:recurring_driver_compliance)).to eq(recurring_driver_compliance)
      end
  ...
  describe "GET #delete" do
    it "assigns the requested recurring_driver_compliance as @recurring_driver_compliance" do
      recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
      get :delete, {:id => recurring_driver_compliance.to_param}
      expect(assigns(:recurring_driver_compliance)).to eq(recurring_driver_compliance)
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested recurring_driver_compliance" do
      recurring_driver_compliance = create :recurring_driver_compliance, provider: @current_user.current_provider
      expect {
        delete :destroy, {:id => recurring_driver_compliance.to_param}
      }.to change(RecurringDriverCompliance, :count).by(-1)
    end
  ...
  describe "GET #preview_schedule" do
    it "assigns a newly created but unsaved recurring_driver_compliance as @recurring_driver_compliance" do
      get :preview_schedule, {:recurring_driver_compliance => valid_attributes}
      expect(assigns(:recurring_driver_compliance)).to be_a_new(RecurringDriverCompliance)
    end
  ...
  describe "GET #preview_future_schedule" do
    it "assigns a newly created but unsaved recurring_driver_compliance as @recurring_driver_compliance" do
      get :preview_future_schedule, {:recurring_driver_compliance => valid_attributes}
      expect(assigns(:recurring_driver_compliance)).to be_a_new(RecurringDriverCompliance)
    end
  ...
  describe "GET #preview_compliance_date_based_schedule" do
    it "assigns a newly created but unsaved recurring_driver_compliance as @recurring_driver_compliance" do
      get :preview_compliance_date_based_schedule, {:recurring_driver_compliance => valid_attributes}
      expect(assigns(:recurring_driver_compliance)).to be_a_new(RecurringDriverCompliance)
    end
