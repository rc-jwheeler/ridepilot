...
RSpec.describe AddressGroupsController, type: :controller do
  login_admin_as_current_user

  # This should return the minimal set of attributes required to create a valid
  # AddressGroup. As you add validations to AddressGroup, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    attributes_for(:address_group)
  }
  ...
  # AddressGroupsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
