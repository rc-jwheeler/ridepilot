  ...
  describe "nested on drivers" do
    ...
    describe "GET #edit" do
      it "assigns the requested document as @document" do
        ...
        get :edit, params: {:id => @document.to_param, driver_id: @driver.to_param}
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new Document" do
          expect {
            post :create, params: {:document => valid_attributes, driver_id: @driver.to_param}
      ...
      context "with invalid params" do
        it "assigns a newly created but unsaved document as @document" do
          post :create, params: {:document => invalid_attributes, driver_id: @driver.to_param}
          expect(assigns(:document)).to be_a_new(Document)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested document" do
          document = create :document, documentable: @driver
          put :update, params: {:id => document.to_param, :document => new_attributes, driver_id: @driver.to_param}
          document.reload
        ...
        it "assigns the requested document as @document" do
          document = create :document, documentable: @driver
          put :update, params: {:id => document.to_param, :document => valid_attributes, driver_id: @driver.to_param}
          expect(assigns(:document)).to eq(document)
        end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested document" do
        document = create :document, documentable: @driver
        expect {
          delete :destroy, params: {:id => document.to_param, driver_id: @driver.to_param}
        }.to change(Document, :count).by(-1)
      end
  ...
  describe "nested on vehicles" do
    ...
    describe "GET #edit" do
      it "assigns the requested document as @document" do
        ...
        get :edit, params: {:id => @document.to_param, vehicle_id: @vehicle.to_param}
        expect(assigns(:document)).to eq(@document)
      end
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new Document" do
          expect {
            post :create, params: {:document => valid_attributes, vehicle_id: @vehicle.to_param}
          }.to change(Document, :count).by(1)
        end
      ...
      context "with invalid params" do
        it "assigns a newly created but unsaved document as @document" do
          post :create, params: {:document => invalid_attributes, vehicle_id: @vehicle.to_param}
          expect(assigns(:document)).to be_a_new(Document)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested document" do
          document = create :document, documentable: @vehicle
          put :update, params: {:id => document.to_param, :document => new_attributes, vehicle_id: @vehicle.to_param}
          document.reload
          expect(document.description).to eq("My New Description")
        end
        ...
        it "assigns the requested document as @document" do
          document = create :document, documentable: @vehicle
          put :update, params: {:id => document.to_param, :document => valid_attributes, vehicle_id: @vehicle.to_param}
          expect(assigns(:document)).to eq(document)
        end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested document" do
        document = create :document, documentable: @vehicle
        expect {
          delete :destroy, params: {:id => document.to_param, vehicle_id: @vehicle.to_param}
        }.to change(Document, :count).by(-1)
      end
