  ...
  describe "nested on vehicles" do
    ...
    describe "GET #edit" do
      it "assigns the requested vehicle_maintenance_compliance as @vehicle_maintenance_compliance" do
        ...
        get :edit, params: {:id => vehicle_maintenance_compliance.to_param, vehicle_id: @vehicle.to_param}
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new VehicleMaintenanceCompliance" do
          expect {
            post :create, params: {:vehicle_maintenance_compliance => valid_attributes, vehicle_id: @vehicle.to_param}
      ...
      context "with invalid params" do
        it "assigns a newly created but unsaved vehicle_maintenance_compliance as @vehicle_maintenance_compliance" do
          post :create, params: {:vehicle_maintenance_compliance => invalid_attributes, vehicle_id: @vehicle.to_param}
          expect(assigns(:vehicle_maintenance_compliance)).to be_a_new(VehicleMaintenanceCompliance)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested vehicle_maintenance_compliance" do
          vehicle_maintenance_compliance = create :vehicle_maintenance_compliance, vehicle: @vehicle
          put :update, params: {:id => vehicle_maintenance_compliance.to_param, :vehicle_maintenance_compliance => new_attributes, vehicle_id: @vehicle.to_param}
        ...
        it "assigns the requested vehicle_maintenance_compliance as @vehicle_maintenance_compliance" do
          vehicle_maintenance_compliance = create :vehicle_maintenance_compliance, vehicle: @vehicle
          put :update, params: {:id => vehicle_maintenance_compliance.to_param, :vehicle_maintenance_compliance => valid_attributes, vehicle_id: @vehicle.to_param}
          expect(assigns(:vehicle_maintenance_compliance)).to eq(vehicle_maintenance_compliance)
        end
      ...
      context "with invalid params" do
        it "assigns the vehicle_maintenance_compliance as @vehicle_maintenance_compliance" do
          vehicle_maintenance_compliance = create :vehicle_maintenance_compliance, vehicle: @vehicle
          put :update, params: {:id => vehicle_maintenance_compliance.to_param, :vehicle_maintenance_compliance => invalid_attributes, vehicle_id: @vehicle.to_param}
          expect(assigns(:vehicle_maintenance_compliance)).to eq(vehicle_maintenance_compliance)
        end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested vehicle_maintenance_compliance" do
        vehicle_maintenance_compliance = create :vehicle_maintenance_compliance, vehicle: @vehicle
        expect {
          delete :destroy, params: {:id => vehicle_maintenance_compliance.to_param, vehicle_id: @vehicle.to_param}
        }.to change(VehicleMaintenanceCompliance, :count).by(-1)
      end
