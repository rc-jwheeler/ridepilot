  ...
  describe "nested on drivers" do
    ...
    describe "GET #edit" do
      it "assigns the requested driver_history as @driver_history" do
        ...
        get :edit, params: {:id => driver_history.to_param, driver_id: @driver.to_param}
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new DriverHistory" do
          expect {
            post :create, params: {:driver_history => valid_attributes, driver_id: @driver.to_param}
      ...
      context "with invalid params" do
        it "assigns a newly created but unsaved driver_history as @driver_history" do
          post :create, params: {:driver_history => invalid_attributes, driver_id: @driver.to_param}
          expect(assigns(:driver_history)).to be_a_new(DriverHistory)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested driver_history" do
          driver_history = create :driver_history, driver: @driver
          put :update, params: {:id => driver_history.to_param, :driver_history => new_attributes, driver_id: @driver.to_param}
        ...
        it "assigns the requested driver_history as @driver_history" do
          driver_history = create :driver_history, driver: @driver
          put :update, params: {:id => driver_history.to_param, :driver_history => valid_attributes, driver_id: @driver.to_param}
          expect(assigns(:driver_history)).to eq(driver_history)
        end
      ...
      context "with invalid params" do
        it "assigns the driver_history as @driver_history" do
          driver_history = create :driver_history, driver: @driver
          put :update, params: {:id => driver_history.to_param, :driver_history => invalid_attributes, driver_id: @driver.to_param}
          expect(assigns(:driver_history)).to eq(driver_history)
        end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested driver_history" do
        driver_history = create :driver_history, driver: @driver
        expect {
          delete :destroy, params: {:id => driver_history.to_param, driver_id: @driver.to_param}
        }.to change(DriverHistory, :count).by(-1)
      end
